module my_address::btc_bridgev3 {
    ...
    const E_ZERO_ETH_ADDRESS: u64 = 3;
    ...
    const E_ZERO_ETH_TX_HASH: u64 = 9;
    ...
    public entry fun initialize(
        ...
        assert!(fee_account != @0x0, error::invalid_argument(E_ZERO_ETH_ADDRESS));
    ...
    public entry fun mint(
        ...
        // Validate receiver
        assert!(receiver != @0x0, error::invalid_argument(E_ZERO_ETH_ADDRESS));
        
        // Validate amount
        assert!(amount > bridge_config.fee, error::invalid_argument(E_INSUFFICIENT_AMOUNT));
    ...
    public entry fun redeem_prepare(
        ...
        // Validate tx hash
        assert!(string::length(&redeem_request_tx_hash) > 0, error::invalid_argument(E_ZERO_ETH_TX_HASH));
        ...
        // Validate requester
        assert!(requester != @0x0, error::invalid_argument(E_ZERO_ETH_ADDRESS));
        ...
        event::emit_event(&mut bridge_events.redeem_prepare_events, RedeemPrepareEvent {
            eth_tx_hash: redeem_request_tx_hash,
            requester,
            receiver,
            amount,
            outpoint_tx_ids,
